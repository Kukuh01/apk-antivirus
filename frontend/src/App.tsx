            ...
            <div className="bg-slate-800 rounded-xl shadow-lg p-6">
              ...
              <div className="flex space-x-3">
                ...
                <button
                  onClick={scanFile}
                  disabled={scanning}
                  className="bg-purple-600 hover:bg-purple-700 disabled:bg-slate-600 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center space-x-2 w-40"
                >
            ...
            <div className="bg-slate-800 rounded-xl shadow-lg p-6">
              ...
              <div className="flex space-x-3">
                ...
                <button
                  onClick={scanFolder}
                  disabled={scanning}
                  className="bg-blue-600 hover:bg-blue-700 disabled:bg-slate-600 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center space-x-2 w-40"
                >
                  <Search className="w-5 h-5" />
              ...
              <form onSubmit={addSample} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewSample({ ...newSample, file_path: e.target.value })
                    }
